...
document.head.insertAdjacentHTML('beforeend', '<style>body{background:radial-gradient(circle at 85% 0,#dbeafe 0,#f7faff 34%,#eef4f9 75%)}.app{max-width:1240px;padding:25px}.top{background:linear-gradient(120deg,#0b1f3a,#174f9e);border-radius:20px;padding:20px 22px;color:#fff;box-shadow:0 14px 35px #0f2a4d35}.top .sub{color:#dbeafe}.top .actions{margin:0}.tabs{padding:7px;background:#fff;border:1px solid #dbeafe;border-radius:14px;box-shadow:0 7px 20px #163a5f0b}.tabs button{border:0;font-weight:700}.tabs button.active,.primary{background:linear-gradient(135deg,#2563eb,#123b8b);box-shadow:0 6px 14px #2563eb33}.outline:hover{background:#eff6ff}.card,.panel,.case{border-color:#dbe5f0;border-radius:16px;box-shadow:0 9px 28px #163a5f0c}.card{background:linear-gradient(145deg,#fff,#f7fbff)}.card b{font-size:29px}.table-wrap{border:1px solid #e8eef5;border-radius:12px}table{min-width:1250px}th{background:#f8fafc}input:focus,select:focus,textarea:focus{outline:0;border-color:#60a5fa;box-shadow:0 0 0 3px #dbeafe}.danger{background:#fff1f2!important;color:#b42338!important;border-color:#fecdd3!important}@media(max-width:760px){.app{padding:12px}.top{padding:17px}.tabs{position:sticky;top:6px;z-index:2;overflow:auto;flex-wrap:nowrap}.tabs button{white-space:nowrap}.actions button,.actions select{width:100%}}</style>');
